// Public types for the cross-app search contract. An app implements a
// `SearchProvider` in its own search entry module and exports
// `createSearchProvider`; the host instantiates it with a `SearchProviderContext`
// and calls `search()` when fanning a query out across installed apps. Types
...
export type CreateSearchProvider = (
